...
namespace TeknosipDataAccessLayer.Migrations
{
    ...
    [Migration("20250618142138_CozumTablosuEkle")]
    partial class CozumTablosuEkle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeknosipEntityLayer.Concrete.About", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeknosipEntityLayer.Concrete.AppRole", b =>
                {
            ...
            modelBuilder.Entity("TeknosipEntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TeknosipEntityLayer.Concrete.DestekKurumu", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DestekKurumuId"), 1L, 1);
                    ...
                    b.HasKey("DestekKurumuId");

                    b.ToTable("DestekKurumlari");
                });
            ...
            modelBuilder.Entity("TeknosipEntityLayer.Concrete.DestekTalebi", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DestekTalebiId"), 1L, 1);
            ...
            modelBuilder.Entity("TeknosipEntityLayer.Concrete.Feature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeknosipEntityLayer.Concrete.Sector", b =>
                {
                    b.Property<int>("SectorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("TeknosipEntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TeknosipEntityLayer.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TeknosipEntityLayer.Concrete.Problem", b =>
                {
                    b.HasOne("TeknosipEntityLayer.Concrete.AppUser", "AppUser")
                        .WithMany("Problems")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TeknosipEntityLayer.Concrete.Sector", "Sector")
                        .WithMany("Problems")
